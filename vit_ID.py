...
# torch._six was removed in modern PyTorch
try:
    from torch._six import container_abcs  # old PyTorch
except ImportError:
    import collections.abc as container_abcs  # new PyTorch
...
class PatchEmbed(nn.Module):
    """Image to Patch Embedding (non-overlap)."""
...
# ----------------------------
# TransReID (camera-agnostic)
# ----------------------------
class TransReID(nn.Module):
    """Transformer-based Re-Identification (camera-agnostic)."""

    def __init__(self,
                 img_size=224, patch_size=16, stride_size=16, in_chans=3,
        ...
        # classifier head (kept name as fc to match your repo)
    ...
    def forward(self, x, cam_label=None):
        # cam_label kept only for backward compatibility; ignored
    ...
    def load_param(self, model_path, load=False):
        ...
        for k, v in param_dict.items():
            ...
            try:
                ...
                print('===========================ERROR=========================')
                print(f'shape mismatch: {k}: checkpoint {tuple(v.shape)} vs model {tuple(self.state_dict()[k].shape)}')
...
def _no_grad_trunc_normal_(tensor, mean, std, a, b):
    ...
    if (mean < a - 2 * std) or (mean > b + 2 * std):
        print("Warning: mean is more than 2 std from [a, b] in trunc_normal_.")
